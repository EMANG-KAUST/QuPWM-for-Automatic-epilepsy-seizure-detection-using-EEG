...
global Levels Level_intervals clustering
...
%% Cross-Validation
        subject=1;
        tic
        [sz_fPWM, Accuracy,Avg_sensitivity,Avg_specificity,Avg_precision,Avg_gmean,Avg_f1score,Avg_AUC, QuPWM_str]=PWM_Data_CrossValidation_2(X, y, CV_type_list, K,type_clf_list,clustering);
        exec_time=toc;
   ...
   %% get the LOO performance
        ...
        resolution=k*sigma0;
        cnt_inc=cnt_inc+1;
        Output_results(cnt_inc,:)=[size(X,1),M,mu0,sigma0,k,resolution,sz_fPWM,Accuracy,exec_time];
